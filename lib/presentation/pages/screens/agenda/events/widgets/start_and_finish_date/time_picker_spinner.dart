...
class _TimePickerSpinnerState extends State<TimePickerSpinner> {
  ...
  /// default settings
  TextStyle defaultHighlightTextStyle = const TextStyle(fontSize: 32);
  TextStyle defaultNormalTextStyle = const TextStyle(fontSize: 32);
  TextStyle defaultFadedTextStyle = const TextStyle(fontSize: 32);
  ...
  TextStyle? _getFadedTextStyle() {
    return widget.fadedTextStyle ?? defaultFadedTextStyle;
  }
        ...
        Positioned(
          child: Column(
            children: [
              ...
              SizedBox(height: _getItemHeight()),
              Divider(
                height: 0,
                thickness: 1,
                color: Theme.of(context).dividerColor,
    ...
    Widget spinner = NotificationListener<ScrollNotification>(
      ...
      child: ListView.builder(
        itemBuilder: (context, index) {
          ...
          TextStyle? neededTextStyle = selectedIndex == index
          ...
          return Container(
            ...
            child: Text(
              text,
              style: (neededTextStyle ?? const TextStyle()).copyWith(
                color: neededTextStyle?.color ??
