...
class FinancesController extends GetxController {
  ...
  RxList<EventWithParticipants> financeEventsList = RxList();
  ...
  Future<void> getFinanceEvents({
    ...
    final events = await _agendaController.getAgendaEvents(
      startTime: startTime,
      endTime: endTime,
      categoryId: _agendaController.listOfAgendaNames[1].id,
    );
    ...
    financeEventsList.value = result;
  }
}
